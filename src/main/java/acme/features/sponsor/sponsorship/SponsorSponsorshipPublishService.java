...
public class SponsorSponsorshipPublishService extends AbstractService<Sponsor, Sponsorship> {
	...
	public void bind(final Sponsorship object) {
		assert object != null;
		super.bind(object, "code", "amount", "startDate", "endDate", "type", "contact", "link");
	...
	public void validate(final Sponsorship object) {
		assert object != null;
		super.state(this.validateNoDrafModeInvoices(object.getId()), "*", "sponsor.sponsorship.form.error.draft-invoices");
		super.state(this.validateExistsPublishedInvoices(object.getId()), "*", "sponsor.sponsorship.form.error.exists-invoices");
		...
		if (!super.getBuffer().getErrors().hasErrors("amount")) {
			...
			super.state(this.validateInvoicesAmount(object.getAmount(), object.getId()), "amount", "sponsor.sponsorship.form.error.amount-invoices");
		}
		if (!super.getBuffer().getErrors().hasErrors("amount"))
