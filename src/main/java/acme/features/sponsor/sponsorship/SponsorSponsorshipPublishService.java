...
public class SponsorSponsorshipPublishService extends AbstractService<Sponsor, Sponsorship> {
	...
	public void bind(final Sponsorship object) {
		assert object != null;
		super.bind(object, this.code, this.amount, this.startDate, this.endDate, this.type, this.contact, this.link);
		int projectId = super.getRequest().getData(this.project, int.class);
	...
	public void validate(final Sponsorship object) {
		assert object != null;
		super.state(this.validator.validateNoDrafModeInvoices(object.getId()), "*", "sponsor.sponsorship.form.error.draft-invoices");
		super.state(this.validator.validateExistsPublishedInvoices(object.getId()), "*", "sponsor.sponsorship.form.error.exists-invoices");
		...
		if (!super.getBuffer().getErrors().hasErrors(this.amount)) {
			...
			super.state(this.validator.validateInvoicesAmount(object.getAmount(), object.getId()), "amount", "sponsor.sponsorship.form.error.amount-invoices");
		}
